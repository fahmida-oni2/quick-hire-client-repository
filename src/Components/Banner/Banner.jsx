...
const Banner = () => {
  ...
  return (
    <section className="font-epilogue  overflow-hidden mt-15">
      {/* Hero */}
      <div className="relative bg-[#F8F8FD] min-h-[520px] lg:min-h-[560px] flex items-center lg:[clip-path:polygon(0%_0%,_100%_0%,_100%_calc(100%_-_250px),_calc(100%_-_350px)_100%,_0%_100%)]">
        ...
        <div className="relative z-20 mx-5 sm:mx-10 lg:mx-20 w-full lg:w-[65%] py-12 lg:py-0">
          <h1 className="font-clash text-4xl sm:text-5xl lg:text-6xl font-black text-[#25324B] leading-tight mb-4">
            ...
            <span className="text-[#26A4FF] relative inline-block">
              ...
              >
                <path
                  d="M2 7C70 2 160 1 240 4C268 5.5 295 8 318 5"
                  stroke="#26A4FF"
                  strokeWidth="3.5"
                  strokeLinecap="round"
                />
                <path
                  d="M260 9 L318 5 L308 2"
                  stroke="#26A4FF"
                  strokeWidth="3.5"
                  strokeLinecap="round"
          ...
          <form
            ...
            className="sm:flex items-stretch bg-white p-3 border border-gray-200 shadow-md w-full overflow-visible relative z-20"
          >
            {/* Title Input */}
            <div className="flex items-center gap-2 flex-1 px-4 py-3.5">
              <FiSearch className="shrink-0 text-black" size={15} />
              <input
                type="text"
            ...
            <div className="relative flex-1" ref={dropdownRef}>
              <div className="w-full flex items-center gap-2 px-4 py-3.5 text-sm">
                <FiMapPin className="shrink-0 text-black" size={15} />
                <input
                  type="text"
                  ...
                  className="flex-1 text-sm outline-none text-black placeholder-gray-300 bg-transparent"
                />
                {location && (
                  <button
                    type="button"
                ...
                <FiChevronDown
                  ...
                  className={`text-black shrink-0 transition-transform duration-200 cursor-pointer ${dropdownOpen ? "rotate-180" : ""}`}
                  size={14}
                />
              </div>
            ...
            <button
              type="submit"
              className="bg-primary text-white text-sm font-epilogue font-bold px-8 py-3.5 w-full md:w-50 lg:w-50 hover:opacity-90 transition-opacity cursor-pointer whitespace-nowrap shrink-0  "
            >
              Search my job
            </button>
          </form>
      ...
      {/* Companies Marquee */}
      <div className="mt-4 lg:mt-0 border-t bg-white border-gray-100 font-epilogue pt-8 pb-6">
        ...
        <Marquee
          ...
          pauseOnHover={true}
        >
          <span className="text-[#202430] mx-10">VODAFONE</span>
          <span className="text-[#202430]  mx-10">INTEL</span>
          <span className="text-[#202430]  mx-10">TESLA</span>
          <span className="text-[#202430]  mx-10">AMD</span>
          <span className="text-[#202430]  mx-10">TALKIT</span>
        </Marquee>
      </div>
    </section>
  );
